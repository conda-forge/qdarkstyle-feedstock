About qdarkstyle-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/qdarkstyle-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5510&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/qdarkstyle-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `qdarkstyle` can be installed with `conda`:
...
```
mamba install qdarkstyle
```

It is possible to list all of the versions of `qdarkstyle` available on your platform with `conda`:
...
```
mamba search qdarkstyle --channel conda-forge
```
...
mamba repoquery search qdarkstyle --channel conda-forge

# List packages depending on `qdarkstyle`:
mamba repoquery whoneeds qdarkstyle --channel conda-forge

# List dependencies of `qdarkstyle`:
mamba repoquery depends qdarkstyle --channel conda-forge
```
